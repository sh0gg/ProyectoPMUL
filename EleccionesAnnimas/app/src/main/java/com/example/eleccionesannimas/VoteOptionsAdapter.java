...
public class VoteOptionsAdapter extends
    ...
    public VoteOptionsAdapter(Listener l) {
        this.listener = l;
    }

    public void submit(java.util.List<PollOption> data) {
        items.clear();
        items.addAll(data);
    ...
    static class VH extends RecyclerView.ViewHolder {
        ...
        VH(View v) {
            super(v);
            btn = v.findViewById(R.id.btnVoteOption);
        }
    }
}